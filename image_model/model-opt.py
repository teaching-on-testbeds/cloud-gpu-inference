...
if __name__ == "__main__":
    ...
    parser.add_argument("labelfile_name", type=str, default="mobilenet", help="Name of label file.")
    parser.add_argument("image_name", type=str, default="parrot.jpg", help="Name of image file.")
